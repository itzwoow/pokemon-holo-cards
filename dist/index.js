...
var HoloCard = (props) => {
  ...
  const triggerZoom = react.useCallback(() => {
    const el = cardRef.current;
  ...
  const { seedX, seedY, cosmosX, cosmosY } = react.useMemo(() => {
  ...
  if (cardId && !fetched && !fetchError) {
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: loadingFallback != null ? loadingFallback : /* @__PURE__ */ jsxRuntime.jsx("div", { className: `holo-card-loading ${className}`, style: styleProp, "aria-busy": "true", "aria-label": "Loading card" }) });
  }
  if (fetchError) {
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: errorFallback != null ? errorFallback : /* @__PURE__ */ jsxRuntime.jsx("div", { className: `holo-card-error ${className}`, style: styleProp, role: "img", "aria-label": "Card unavailable" }) });
  }
  if (!imageUrl) {
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: errorFallback != null ? errorFallback : null });
  }
  if (imgError) {
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: errorFallback != null ? errorFallback : /* @__PURE__ */ jsxRuntime.jsx("div", { className: `holo-card-error ${className}`, style: styleProp, role: "img", "aria-label": `${name} failed to load` }) });
  }
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "holo-card__shine" }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "holo-card__glare" })
      ]
    }
  );
};
...
var CardZoomModal = () => {
  ...
  const [targetBox, setTargetBox] = react.useState(null);
  ...
  const runFlip = react.useCallback((detail) => {
    setCard(detail);
    setPhase("flipping");
  ...
  return reactDom.createPortal(
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          phase === "flipping" && /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              ref: stageRef,
          ...
          phase === "open" && targetBox && /* @__PURE__ */ jsxRuntime.jsx(
            "div",
            {
              style: {
                position: "absolute",
          ...
          phase === "open" && /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              onClick: close,
              style: {
...
exports.CardZoomModal = CardZoomModal;
exports.HoloCard = HoloCard;
exports.apiCardToProps = apiCardToProps;
exports.fetchPokemonCard = fetchPokemonCard;
exports.searchPokemonCards = searchPokemonCards;
